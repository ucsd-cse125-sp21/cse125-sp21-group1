...
class Mesh {
 public:
  ...
  void Draw(Shader& shader) {
    // std::cout << "shaderID: in mesh draw " << shader.ID << std::endl;
    ...
    // get base color
    // aiColor4D basecolor(1.0f, 0.0f, 0.0f, 1.0f);
    // material->Get(AI_MATKEY_GLTF_PBRMETALLICROUGHNESS_BASE_COLOR_FACTOR,
    // basecolor); shader.setVec3("base_color",
    // glm::vec3(basecolor.r,basecolor.g,basecolor.b));

    shader.setVec3("material.Ambient", material.Ambient);
    shader.setVec3("material.Diffuse", material.Diffuse);
    shader.setVec3("material.Specular",
                   material.Specular);  // specular lighting doesn't have full
                                        // effect on this object's material
    shader.setFloat("material.Shininess", material.Shininess);

    // std::cout << "after setting material" << std::endl;
