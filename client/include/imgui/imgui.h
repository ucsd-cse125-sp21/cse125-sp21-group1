...
IMGUI_API void TableSetColumnEnabled(
    int column_n,
    bool v);  // change enabled/disabled state of a column, set to false to hide
              // the column. Note that end-user can use the context menu to
...
enum ImGuiTableColumnFlags_ {
  ...
  ImGuiTableColumnFlags_NoReorder =
      1 << 5,  // Disable manual reordering this column, this will also prevent
  ...
  ImGuiTableColumnFlags_NoHeaderWidth =
      1 << 11,  // Disable header text width contribution to automatic column
                // width.
  ImGuiTableColumnFlags_PreferSortAscending =
      1 << 12,  // Make the initial sort direction Ascending when first sorting
                // on this column (default).
  ImGuiTableColumnFlags_PreferSortDescending =
      1 << 13,  // Make the initial sort direction Descending when first sorting
                // on this column.
  ...
  ImGuiTableColumnFlags_IndentDisable =
      1 << 15,  // Ignore current Indent value when entering cell (default for
