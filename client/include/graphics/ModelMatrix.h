...
class ModelMatrix {
 ...
 public:
  ...
  /* Use to convert glm::radians(90.0f) to convert from degree (90 in this case)
   * to radians */
  ...
  void rotate(float angle, float vx, float vy, float vz, float x, float y,
              float z) {
